...
var Curseforge = /** @class */ (function () {
    ...
    Curseforge.prototype.get_mods = function (mod) {
        var _this = this;
        var mods = [];
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var res, mods_1, _i, _a, mod_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mods.push(mod);
                        return [4 /*yield*/, utils.get(this.API_URL + "mods", { modIds: mods })];
                    case 1:
                        res = _b.sent();
                        switch (res.code) {
                            case 200:
                                ...
                                for (_i = 0, _a = res.data.data; _i < _a.length; _i++) {
                                    mod_1 = _a[_i];
                                    mods_1.push(new objects_1.Mod(this, mod_1));
                                }
                                resolve(mods_1);
                                break;
                            case 400:
    ...
    Curseforge.prototype.get_file_changelog = function (mod, file) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils.get(this.API_URL + "mods/" + utils.cleanse(mod) + "/files/" + utils.cleanse(file))];
                    case 1:
                        res = _a.sent();
                        switch (res.code) {
                            case 200:
